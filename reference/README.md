...
```text
/nfs10/data3/m24.YFMa/my-python-project/logs/train/smoke_train.log
```
...
Do not run training locally on Windows. Use `python train.py --config configs/train.yaml` only inside the remote `PISR2-2` conda environment.
...
```text
/nfs10/data3/m24.YFMa/my-python-project/
```
